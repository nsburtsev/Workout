...
//  Workout
//
//  Created by Нюргун on 05.09.2023.
//
...
final class TrainingCellView: UICollectionViewCell {
    ...
    private let checkmarkView = UIImageView(image: R.Images.Overview.checkmarkch)
    ...
    func configure(with title: String, subtitle: String, isDone: Bool) {
        ...
        checkmarkView.image = isDone ? R.Images.Overview.checkmarkChecked : R.Images.Overview.checkmark
    }
}
